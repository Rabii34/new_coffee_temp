...
if(isset($_POST['register'])){
  ...
  $user_email = mysqli_real_escape_string( $connection , $_POST['username']);
  $user_password = mysqli_real_escape_string( $connection , $_POST['username']);
  ...
  if(mysqli_num_rows($email_query) > 0){
    ...
    $query = "INSERT INTO `admin-signup` (`name`, `email`, `password`) VALUES ('$user_name', '$user_email', '$user_password')";
