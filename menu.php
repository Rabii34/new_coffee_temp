...
$fetching_pro = "SELECT * from products where status= 1 limit {$offset}, {$limit}";
    ...
    <section class="ftco-menu mb-5 pb-5">
		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
						...
						<?php
						$drinks_fetch="SELECT * from products";
						$conn_query =mysqli_query($connection,$drinks_fetch);
      ...
      if(mysqli_num_rows($product) > 0){
        ...
        if($getpageno > 1){
          ...
          echo "<li class='page-item'><a class='page-link' href='menu.php?.($getpageno - 1).''> Prev </a></li>";
        }
        for($i = 1; $i <= $pages; $i++){
          $active = $i == $getpageno? "active" : "";
          echo " <li class='page-item'>
          <a class='page-link {$active}' href='menu.php?pageno={$i}'>{$i}</a>
          </li>";
        }
        if($pages > $getpageno){
  
          echo "<li class='page-item'><a class='page-link' href='menu.php?.($getpageno + 1).''> next </a></li>";
        }
      }
